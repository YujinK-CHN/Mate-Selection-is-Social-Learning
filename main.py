...
from algos.hippo_asyn import Hippo
from algos.hippo_syn import Hippo2
...
def create_env(config):
    ...
    if config['env_name'] == 'waterworld':
        waterworld = waterworld_v4.parallel_env(n_pursuers=config['n_agents'], n_evaders=8, n_poisons=10, n_coop=2, n_sensors=20,\
...
if __name__ == "__main__":
    ...
    """ ALGO SETUP """
    policy = HierPolicy_prompt(env, config)
    hippo = Hippo2(env, policy, config)
